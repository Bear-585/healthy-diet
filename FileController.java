...
public class FileController {
    ...
    public R upload(@RequestParam("file") MultipartFile file, String type) {
        try {
            ...
            */
		    // FileUtils.copyFile(dest, new File("D:\\biyesheji\\springboot26d434eo\\src\\main\\resources\\static\\upload"+"/"+fileName)); /**修改了路径以后请将该行最前面的//注释去掉**/
            String projectRootPath = System.getProperty("user.dir");
            File backupUploadDir = new File(projectRootPath, "src/main/resources/static/upload");
            if (!backupUploadDir.exists()) {
                backupUploadDir.mkdirs();
            }

            File backupFile = new File(backupUploadDir, fileName);
            FileUtils.copyFile(dest, backupFile);
